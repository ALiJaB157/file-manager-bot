...
----config----
local bot_api_key = ""
local BASE_URL = "https://api.telegram.org/bot137192291:AAFDfw_dHIvNmpZp5yiBGQ26AL8SVlyytlI"..bot_api_key
-- Base folder like
-- local BASE_FOLDER = "/home/imandaneshi/files/"
local BASE_FOLDER = "/home/ubuntu/workspace/files"
-------
...
function is_admin(msg)-- Check if user is admin or not
  local var = false
  local admins = {209070618}-- put your id here
